...
class LearningPathManually:
    def __init__(self, map_name, movement, stop_event):
        ...
        self.exploration_data = []  # Example data structure to store exploration data
    ...
    def start_capturing(self):
        ...
        while not self.stop_event.is_set():
            ...
            if not self.running:
                break
            self.interface.sleep_with_stop_check(0.1)
